...
public class TestLogikaIgre extends TestCase {
	...
	public void testIgra() {
		...
		//Polozaj belega igralca je na zaèetku nastavljen na (3,3) - le v testu, sicer je random!
		assertEquals(3, igra.polozajIgralca().getX());
		//Beli igralec ima pri teh koordinatah na zaèetku možnih 8 potez
		assertEquals(8, igra.poteze().size());
		
		// Naredimo eno potezo
		igra.odigraj(igra.poteze().get(0));
		
		//Polozaj èrnega igralca je na zaèetku nastavljen na (0,0) - le v testu, sicer je random!
		...
		//Po eni odigrani potezi je št. aktivnih polj N*N-3
